...
Finally let's visualize the portion of the track where Verstappen had the throttle 100% open in the 2023 Canadian GP.
...
ggplot2::ggplot(ver_can, ggplot2::aes(x, y, color = as.factor(open_throttle), group = NA)) +
  ggplot2::geom_path(linewidth = 4, lineend = 'round') +
  ggplot2::scale_color_manual( values = c('white', 'red')) +
  theme_dark_f1() +
      ggplot2::labs(
