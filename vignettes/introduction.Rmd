...
load_driver_telemetry(2022, 1, driver = "LEC", fastest_only = TRUE)
```
...
lec <- load_driver_telemetry(2022, 1, driver = "LEC", fastest_only = TRUE) %>%
  head(300)
...
```{r triple_plot}
ham <- load_driver_telemetry(2022, 1, "Q", driver = "HAM", fastest_only = TRUE) %>%
  head(300)

per <- load_driver_telemetry(2022, 1, driver = "PER", fastest_only = TRUE) %>%
  head(300)
