...
For a simpler visualization let's look at the average time it took each team to pit in round 4 of 2023. For this we will have to load the pit data, the results dataframe (to extract driver + team combos), and the constructor dataframe to get the colors for our plot.

```{r}
pit_data <- load_pitstops(2023, 4)

driver_team <- load_results() %>% 
