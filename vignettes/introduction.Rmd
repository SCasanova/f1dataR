...
<div class="figure">
<img src="introduction-tire_life-1.png" alt="Average laptime per tire type and age at Spanish Grand Prix 2023" width="100%" />
<p class="caption">Average laptime per tire type and age at Spanish Grand Prix 2023</p>
</div>
...
ggplot(pit_constructor, aes(x = constructor_id, y = pit_time, fill = constructor_id)) +
  ...
  ggtitle("Average time in pit lane for each team", subtitle = "Azerbijan Grand Prix 2023")
```
