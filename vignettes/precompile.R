...
knitr::knit("vignettes/jolpica-data-analysis.Rmd.orig", "vignettes/jolpica-data-analysis.Rmd")
...
vig_images<-list.files(pattern = "(jolpica-data-analysis|introduction|plotting-turn-info|alonso-penalty)-[(a-z)(A-Z)(0-9)_]*-1.png")
