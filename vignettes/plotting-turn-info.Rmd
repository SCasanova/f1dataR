...
<div class="figure">
<img src="plotting-turn-info-telem_plot-1.png" alt="plot of chunk telem_plot" width="100%" />
<p class="caption">plot of chunk telem_plot</p>
</div>
...
<div class="figure">
<img src="plotting-turn-info-telem_with_corners-1.png" alt="plot of chunk telem_with_corners" width="100%" />
<p class="caption">plot of chunk telem_with_corners</p>
</div>
...
labelled_gear_plot <- correct_track_ratio(labelled_gear_plot)
```

<div class="figure">
<img src="plotting-turn-info-basic_track_plot-1.png" alt="plot of chunk basic_track_plot" width="100%" />
<p class="caption">plot of chunk basic_track_plot</p>
</div>
...
<div class="figure">
<img src="plotting-turn-info-basic_track_plot-2.png" alt="plot of chunk basic_track_plot" width="100%" />
<p class="caption">plot of chunk basic_track_plot</p>
</div>
...
With those new label x and y points calculated, we can replot the labels, this time adding short segments to connect each label and turn. 
...
labelled_gear_plot2 <- correct_track_ratio(labelled_gear_plot2)
```

<div class="figure">
<img src="plotting-turn-info-relabelled_gear_plot-1.png" alt="plot of chunk relabelled_gear_plot" width="100%" />
<p class="caption">plot of chunk relabelled_gear_plot</p>
</div>
...
<div class="figure">
<img src="plotting-turn-info-relabelled_gear_plot-2.png" alt="plot of chunk relabelled_gear_plot" width="100%" />
<p class="caption">plot of chunk relabelled_gear_plot</p>
</div>
